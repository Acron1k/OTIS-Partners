...
export default function Header() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 ${isScrolled ? 'bg-sand-50/90 backdrop-blur-md py-4 shadow-sm border-b border-charcoal/5' : 'bg-transparent py-8'}`}
    >
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between">
          ...
          >
            <span className="text-2xl font-black tracking-tighter text-charcoal">OTIS</span>
          </div>
            ...
            <div className="flex flex-col space-y-6">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-xl font-bold text-charcoal uppercase tracking-widest"
                >
                  {link.name}
                </a>
              ))}
