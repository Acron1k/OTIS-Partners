...
const benefits = [
  ...
  },
  {
    ...
    fullDesc: "Поддерживаем дизайнеров на всех этапах: консультируем по техническим нюансам раздвижных систем, помогаем с расчётами, подбираем лучшие материалы для вашего проекта. Ваша экспертность в визуале + наша в технической части.",
    icon: HelpCircle,
    className: "bg-white",
  },
  {
    ...
    fullDesc: "Для мебельных салонов и шоурумов: обучаем персонал работе с нашими конструкциями, предоставляем образцы материалов за нашу стоимость. Помогаем вашим продавцам уверенно продавать нашу продукцию.",
    icon: GraduationCap,
    className: "bg-white",
  },
];
